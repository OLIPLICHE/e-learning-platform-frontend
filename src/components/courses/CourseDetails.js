...
const CourseImg = styled.img.attrs((props) => ({
  src: props.src,
}))`
  width: 80%;
`;
...
const findCourseById = (id, courses) => {
  let course = null;
  courses.forEach((currCourse) => {
    if (currCourse.id === parseInt(id, 10)) course = currCourse;
  });
  return course;
};
...
const CourseDetails = () => {
  ...
  const course = findCourseById(course_id, courses);
        ...
        <div className="row">
          <FirstColumn className="col-12 col-lg-8" style={{ padding: 0 }}>
            ...
            <div className="d-flex p-relative align-items-end w-100">
              <ReturnButton onClick={() => navigate('/courses', { replace: true })}>
                <ArrowBackIosIcon />
              </ReturnButton>
          ...
          <SecondColumn className="col-12 col-lg-4" style={{ maxHeight: '90%', padding: '0 2.3rem' }}>
            <div className="text-end">
              ...
              <SubTitle>
                Rent this course for a week and receive 1 extra day!
              </SubTitle>
            </div>
            ...
            <DetailsTable>
              <DetailsTableRow>
                ...
                <p>
                  $
                  {course.description.price_daily}
                </p>
              </DetailsTableRow>
              <DetailsTableRow>
                <p>
                ...
                <p>
                  $
                  {course.description.price_daily * 7 }
                </p>
              </DetailsTableRow>
              <DetailsTableRow>
                <p>
                ...
                <p>
                  $
                  {course.description.price_monthly * 0.7}
                </p>
              </DetailsTableRow>
              <DetailsTableRow>
                <p>
                ...
                <p>
                  %
                  {course.description.insurance_fee}
                </p>
              </DetailsTableRow>
            </DetailsTable>
            <PromoHeader>
